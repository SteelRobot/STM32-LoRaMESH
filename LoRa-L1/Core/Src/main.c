...
int main(void)
{
  ...
  /* USER CODE BEGIN 2 */
	...
	LoRa_Init(&huart1, &huart2, &hrtc, &htim2, E220_900T22D);
...
//	LoRa_Set_Address(2);
  ...
  /* USER CODE BEGIN WHILE */
	while (1) {
//		__WFI(); // For some reason breaks the thing :( Had to erase the chip on one of my MCUs, though the other worked fully fine smh
    /* USER CODE END WHILE */
