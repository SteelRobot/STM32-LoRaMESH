...
#define DATA_BASE_PKT_LEN (OPCODE_OFFSET + LENGTH_OFFSET + RESERVED_OFFSET + NUM_HOPS_LEN + TRANSMITTER_ID_LEN + RECEIVER_ID_LEN + DESTINATION_ID_LEN + SOURCE_ID_LEN + SEQUENCE_NUM_LEN + SEQUENCE_NUM_LEN)
...
#define PING_PKT_LEN (LORA_OFFSET + OPCODE_OFFSET + LENGTH_OFFSET + RESERVED_OFFSET + NUM_HOPS_LEN + TRANSMITTER_ID_LEN + RECEIVER_ID_LEN + DESTINATION_ID_LEN + SOURCE_ID_LEN + REQUEST_OR_REPLY_LEN + TIMESTAMP_LEN)
